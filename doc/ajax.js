...
function ajax(index){
  ...
  var isPDF = (URL_list[index].indexOf(".pdf")==URL_list[index].length-4);
...
function plot(index, title, description, image){
  ...
  var deskCode = "<div class=\"description\">" + description + "</div><br>";
